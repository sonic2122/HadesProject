...
Logo.Size = UDim2.new(0,70,0,70); Logo.Position = UDim2.new(0.5,-35,0,15); Logo.BackgroundTransparency = 1; Logo.Image = "rbxassetid://13508139595"

local Title = Instance.new("TextLabel", Side)
Title.Text = "HADES SOFTWARE"; Title.Position = UDim2.new(0,0,0,90); Title.Size = UDim2.new(1,0,0,30); Title.TextColor3 = Color3.new(1,1,1); Title.Font = "GothamBold"; Title.BackgroundTransparency = 1; Title.TextSize = 14
...
local TabContainer = Instance.new("Frame", Side); TabContainer.Size = UDim2.new(1,0,1,-140); TabContainer.Position = UDim2.new(0,0,0,130); TabContainer.BackgroundTransparency = 1
...
-- PLAYER LIST TP/BRING SYSTEM
local function UpdatePlayerList()
    PlayerP:ClearAllChildren(); Instance.new("UIListLayout", PlayerP).Padding = UDim.new(0,5)
    for _, p in pairs(Players:GetPlayers()) do
        if p ~= LocalPlayer then
            ...
            pBtn.MouseButton1Click:Connect(function()
                ...
                pBtn.BackgroundColor3 = Color3.fromRGB(100,0,0)
                task.wait(0.5)
...
local function ActionBtn(pg, txt, func)
    local b = Instance.new("TextButton", pg); b.Size = UDim2.new(1,-20,0,40); b.Text = txt; b.BackgroundColor3 = Color3.fromRGB(40,40,40); b.TextColor3 = Color3.new(1,1,1); Instance.new("UICorner", b); b.MouseButton1Click:Connect(func)
end
...
-- Players Actions
ActionBtn(PlayerP, "Teleport to Selected", function() if _G.HadesSettings.Target then LocalPlayer.Character.HumanoidRootPart.CFrame = _G.HadesSettings.Target.Character.HumanoidRootPart.CFrame end end)
ActionBtn(PlayerP, "Bring Selected", function() if _G.HadesSettings.Target then _G.HadesSettings.Target.Character.HumanoidRootPart.CFrame = LocalPlayer.Character.HumanoidRootPart.CFrame end end)
ActionBtn(PlayerP, "Refresh Player List", UpdatePlayerList)
